...
| --- | --- |
| **Utilities** | 25 local crypto/text utilities: SHA-1/256/384/512, MD5, CRC-32, hash identification, ROT (all shifts + ROT47), Caesar, Atbash, Vigenère, XOR (incl. single-byte key recovery), Morse, Base64/Base64URL, Hex, URL & HTML encoders, Unicode escapes + normalization, ASCII⇄binary, JWT decode + HMAC verify, encoding identifier, base conversion (2–62), **encoding converter (binary/octal/decimal/hex/Base32/36/58/62/64/64URL)**, RSA calculator (BigInt, factor fallback), case conversion, whitespace removal, text statistics, cryptographic random generators |
