...
| --- | --- |
| **Tools** | 23 local crypto/text utilities: SHA-1/256/384/512, MD5, CRC-32, hash identification, ROT (all shifts + ROT47), Caesar, Atbash, Vigenère, XOR (incl. single-byte key recovery), Morse, Base64/Base64URL, Hex, URL & HTML encoders, Unicode escapes + normalization, ASCII⇄binary, JWT decode + HMAC verify, encoding identifier, base conversion (2–62), RSA calculator (BigInt, factor fallback), case conversion, text statistics, cryptographic random generators |
